...
import 'package:info_keeper/pages/home_page/items/old_chat_page/chat_favorites_page.dart';
import 'package:info_keeper/pages/home_page/items/old_chat_page/chat_media.dart';
import 'package:info_keeper/pages/home_page/items/old_chat_page/chat_search.dart';
import 'package:info_keeper/pages/home_page/items/old_chat_page/chat_titles_page.dart';
import 'package:info_keeper/pages/home_page/items/old_chat_page/chat_vault_page.dart';
import 'package:info_keeper/pages/home_page/items/old_chat_page/widgets/chat_bottom_text_field.dart';
import 'package:info_keeper/pages/home_page/items/old_chat_page/widgets/chat_pinned_message.dart';
import 'package:info_keeper/pages/home_page/items/old_chat_page/widgets/chat_body.dart';
import 'package:info_keeper/pages/home_page/items/old_chat_page/widgets/chat_title.dart';
import 'package:info_keeper/pages/home_page/items/old_chat_page/widgets/message_menu/chat_colors_selector.dart';
                        ...
                        IconButton(
                            onPressed: () {
                              for (int i = 1;
                                  ...
                                  i++) {
                                selectedMessages[0].title =
                                    '${selectedMessages[0].title}\n${selectedMessages[i].title}';
